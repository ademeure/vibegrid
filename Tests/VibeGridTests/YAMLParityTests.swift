...
private func assertParityConfig(_ config: AppConfig, sourceContext: SourceLocation = #_sourceLocation) {
    ...
    #expect(config.settings.moveEverythingITermRecentActivityTimeout == 7, sourceLocation: sourceContext)
    #expect(config.settings.moveEverythingITermRecentActivityActiveText == "[LIVE]", sourceLocation: sourceContext)
    #expect(config.settings.moveEverythingITermRecentActivityIdleText == "[idle]", sourceLocation: sourceContext)
    #expect(config.settings.moveEverythingITermRecentActivityBadgeEnabled == true, sourceLocation: sourceContext)
    #expect(config.settings.moveEverythingITermRecentActivityColorize == true, sourceLocation: sourceContext)
    #expect(config.settings.moveEverythingITermTitleFromBadge == false, sourceLocation: sourceContext)
    #expect(config.settings.moveEverythingITermRecentActivityActiveColor == "#228844", sourceLocation: sourceContext)
    #expect(config.settings.moveEverythingITermRecentActivityIdleColor == "#AA3333", sourceLocation: sourceContext)
    ...
    #expect(left.canMoveControlCenter == false, sourceLocation: sourceContext)
    ...
    #expect(center.canMoveControlCenter == true, sourceLocation: sourceContext)
...
@Test func yamlParityTwoAndFourSpaceProduceSameConfig() throws {
    ...
    #expect(config2.settings.moveEverythingITermRecentActivityTimeout == config4.settings.moveEverythingITermRecentActivityTimeout)
    #expect(config2.settings.moveEverythingITermRecentActivityActiveText == config4.settings.moveEverythingITermRecentActivityActiveText)
    #expect(config2.settings.moveEverythingITermRecentActivityBadgeEnabled == config4.settings.moveEverythingITermRecentActivityBadgeEnabled)
    #expect(config2.settings.moveEverythingITermRecentActivityColorize == config4.settings.moveEverythingITermRecentActivityColorize)
    #expect(config2.settings.moveEverythingITermTitleFromBadge == config4.settings.moveEverythingITermTitleFromBadge)
    #expect(config2.settings.moveEverythingITermRecentActivityActiveColor == config4.settings.moveEverythingITermRecentActivityActiveColor)
    #expect(config2.settings.moveEverythingITermRecentActivityIdleColor == config4.settings.moveEverythingITermRecentActivityIdleColor)
...
@Test func yamlEncodeDecodeRoundTripPreservesAllSettings() throws {
    ...
    #expect(roundTripped.settings.moveEverythingITermRecentActivityTimeout == original.settings.moveEverythingITermRecentActivityTimeout)
    #expect(roundTripped.settings.moveEverythingITermRecentActivityActiveText == original.settings.moveEverythingITermRecentActivityActiveText)
    #expect(roundTripped.settings.moveEverythingITermRecentActivityIdleText == original.settings.moveEverythingITermRecentActivityIdleText)
    #expect(roundTripped.settings.moveEverythingITermRecentActivityBadgeEnabled == original.settings.moveEverythingITermRecentActivityBadgeEnabled)
    #expect(roundTripped.settings.moveEverythingITermRecentActivityColorize == original.settings.moveEverythingITermRecentActivityColorize)
    #expect(roundTripped.settings.moveEverythingITermTitleFromBadge == original.settings.moveEverythingITermTitleFromBadge)
    #expect(roundTripped.settings.moveEverythingITermRecentActivityActiveColor == original.settings.moveEverythingITermRecentActivityActiveColor)
    #expect(roundTripped.settings.moveEverythingITermRecentActivityIdleColor == original.settings.moveEverythingITermRecentActivityIdleColor)
    ...
    for i in 0..<original.shortcuts.count {
        ...
        #expect(roundTripped.shortcuts[i].canMoveControlCenter == original.shortcuts[i].canMoveControlCenter)
