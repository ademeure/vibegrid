...
struct YAMLConfigCodec {
    ...
    static func encode(_ config: AppConfig) -> String {
        ...
        lines.append("  defaultGridColumns: \(normalized.settings.defaultGridColumns)  # grid columns for new shortcuts (1-50)")
        lines.append("  defaultGridRows: \(normalized.settings.defaultGridRows)  # grid rows for new shortcuts (1-50)")
